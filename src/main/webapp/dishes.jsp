			...
			<div class="col-md-10 col-md-push-1">
				...
				<c:forEach items="${sessionScope.dlist }" var="d1">
				    <tr>
						...
						<c:if test="${d1.quantity!=0 }">
						<td><a href="addcar?dish_id=${d1.dish_id }">点餐</a></td>
						</c:if>
						<c:if test="${d1.quantity==0 }">
						<td>售罄</td>
						</c:if>
				...
				<c:if test="${sessionScope.pageno!=null }">
					...
					<li><a href="dodishes?flag=up&sign=${0}">上一页</a></li>
					
					<li><a href="dodishes?flag=down&sign=${0}">下一页</a></li>
				</c:if>
