...
<!--导航-->
		...
		<div class="row" style="height: 300px; text-align: center;">
			<div class="col-md-10 col-md-push-1">
				...
				<c:forEach items="${sessionScope.dlist2 }" var="d2">
				    <tr>
						<td>${d2.dish_id }</td>
						<td>${d2.dish_name}</td>
						<td>${d2.price}</td>
						<td>${d2.quantity }</td>
						<td><a href="addcar?dish_id=${d2.dish_id }">点餐</a></td>
					</tr>
				...
				<c:if test="${sessionScope.pageno!=null }">
					...
					<li><a href="dosearch?flag=up">上一页</a></li>
					
					<li><a href="dosearch?flag=down">下一页</a></li>
				</c:if>
