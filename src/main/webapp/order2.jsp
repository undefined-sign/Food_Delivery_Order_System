			...
			<div class="col-md-10 col-md-push-1">
				...
				<c:forEach items="${sessionScope.ovlist }" var="o">
				    <tr>
						...
						<td>${o.address}</td>
						<td>${o.sum}</td>
						<td><a href="updateorderstatus?order_id=${o.order_id }&status=${'01'}">接单</a></td>
						<td><a href="updateorderstatus?order_id=${o.order_id}&status=${'10'}">拒收</a></td>
						
						<td><a href="order_detail2.jsp?uid=${o.uid }&order_id=${o.order_id}"> 详情</a></td>
					</tr>
				</c:forEach>
				</table>
				<ul class="pagination">
